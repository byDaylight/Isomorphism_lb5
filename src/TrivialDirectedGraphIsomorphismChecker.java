...
public class TrivialDirectedGraphIsomorphismChecker
    ...
    getIsomorphism(Graph<DirectedGraphNode> graph1,
        ...
        if (graph1.size() != graph2.size()) {
            System.out.println("У графів різна кількість вершин, тому графи не ізоморфні");
            return null;
        }

        if (graph1.getNumberOfEdges() != graph2.getNumberOfEdges()) {
            System.out.println("У графів різна кількість ребер, тому графи не ізоморфні");
            return null;
        }
    ...
    findIsomorphismPermutation(List<List<DirectedGraphNode>> groupList1,
        ...
        System.out.println("Не знайдено жодної перестановки, графи не ізоморфні");
        return null;
    }
